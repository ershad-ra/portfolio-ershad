...
const TabSidebar = ({ tabs, activeTab, setActiveTab, onSubmenuClick, color = 'purple' }) => {
  ...
  const themes = {
    ...
    emerald: { 
      ...
      icon: 'text-emerald-400', hover: 'hover:text-emerald-400',
      scroll: '[&::-webkit-scrollbar-thumb]:bg-emerald-500/30 hover:[&::-webkit-scrollbar-thumb]:bg-emerald-500/50'
    },
    teal: { 
      active: 'bg-teal-500/10 border-teal-500/50 text-teal-400', 
      icon: 'text-teal-400', hover: 'hover:text-teal-400',
      scroll: '[&::-webkit-scrollbar-thumb]:bg-teal-500/30 hover:[&::-webkit-scrollbar-thumb]:bg-teal-500/50'
    },
    sky: { 
      active: 'bg-sky-500/10 border-sky-500/50 text-sky-400', 
      icon: 'text-sky-400', hover: 'hover:text-sky-400',
      scroll: '[&::-webkit-scrollbar-thumb]:bg-sky-500/30 hover:[&::-webkit-scrollbar-thumb]:bg-sky-500/50'
    }
  };
